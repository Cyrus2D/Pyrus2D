...
class BodySensor:
    ...
    def __str__(self):
        return f'''
                ...
                effort: {self._effort},
                stamina_capacity: {self._stamina_capacity},
                speed_mag: {self._speed_mag},
                speed_dir_relative: {self._speed_dir_relative},
                neck_relative: {self._neck_relative},
                kick_count: {self._kick_count},
                dash_count: {self._dash_count},
                turn_count: {self._turn_count},
                say_count: {self._say_count},
                turn_neck_count: {self._turn_neck_count},
                catch_count: {self._catch_count},
                move_count: {self._move_count},
                change_view_count: {self._change_view_count},
                change_focus_count: {self._change_focus_count},
                arm_movable: {self._arm_movable},
                arm_expires: {self._arm_expires},
                pointto_dist: {self._pointto_dist},
                pointto_dir: {self._pointto_dir},
                pointto_count: {self._pointto_count},
                attentionto_side: {self._attentionto_side},
                attentionto_unum: {self._attentionto_unum},
                attentionto_count: {self._attentionto_count},
                tackle_expires: {self._tackle_expires},
                tackle_count: {self._tackle_count},
                none_collided: {self._none_collided},
                ball_collided: {self._ball_collided},
                player_collided: {self._player_collided},
                post_collided: {self._post_collided},
                charged_expires: {self._charged_expires},
                card: {self._card},
                focus_point_dist: {self._focus_point_dist},
                focus_point_dir: {self._focus_point_dir},
                '''
