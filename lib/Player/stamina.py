...
class Stamina:
    def __init__(self, stamina=None, effort=None, recovery=None, capacity=None):
        self._stamina = stamina if stamina else SP.DEFAULT_STAMINA_MAX
        self._effort = effort if effort else SP.DEFAULT_EFFORT_INIT
        self._recovery = recovery if recovery else SP.DEFAULT_RECOVER_INIT
